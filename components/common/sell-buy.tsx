...
<div className="flex flex-row items-center  gap-34  text-white ">
        <div className="flex flex-row items-center justify-center bg-[#405FF2] w-33 h-15 rounded-xl " >
          <Link href="#" className="flex flex-row items-center justify-center "> Get Started <ArrowUpRight size = '20'/>  </Link>
        </div>
<div className=""><Car  size= '90' className="text-blue-500"/></div>
...
<div className=""><Van  size= '90' className="text-blue-500"/></div>
