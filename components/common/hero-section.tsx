...
export default function HeroSection() {
  ...
  useEffect(() => {
    ...
    return () => console.log("didmount hero");
  }, []);
  ...
  return (
    ...
    //           <p className="mt-4 text-xl font-bold md:text-4xl  lg:text-6xl">
    //             {h("perfectCar")}
    //           </p>
    ...
    //   </div>
    // </div>
    <div className="size-20 bg-red-500">hellos</div>
  );
}
